package com.zhangchongshan.fragmentdemo.fragment;
...
import com.zhangchongshan.fragmentdemo.R;
...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.mipmap.ic_home_focused,
				R.string.tab_home, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
		mIndicators[0].setBackgroundResource(R.mipmap.indic_select);
		mIndicators[0].setTag(Integer.valueOf(0));
		mIndicators[0].setOnClickListener(this);
		addView(mIndicators[0]);
		mIndicators[1] = createIndicator(R.mipmap.ic_search_normal,
		...
		mIndicators[2] = createIndicator(R.mipmap.ic_settings_normal,
	...
	public static void setIndicator(int which) {
		...
		case 0:
			...
			prevIcon.setImageResource(R.mipmap.ic_home_normal);
		...
		case 1:
			...
			prevIcon.setImageResource(R.mipmap.ic_search_normal);
		...
		case 2:
			...
			prevIcon.setImageResource(R.mipmap.ic_settings_normal);
		...
		mIndicators[which].setBackgroundResource(R.mipmap.indic_select);
		ImageView currIcon;
		TextView currText;
		switch(which) {
		case 0:
			currIcon =(ImageView) mIndicators[which].findViewWithTag(TAG_ICON_0);
			currIcon.setImageResource(R.mipmap.ic_home_focused);
		...
		case 1:
			...
			currIcon.setImageResource(R.mipmap.ic_search_focused);
		...
		case 2:
			...
			currIcon.setImageResource(R.mipmap.ic_settings_focused);
